...
export type Arrival = { route_id?: string | null; route?: Route | null; vehicle_id?: string | null; trip_id?: string | null; our_eta?: string | null; eta_range?: [string, string] | null; confidence: number; prediction_source: string; passio_eta?: string | null; data_age_seconds?: number | null }
export type RouteDetail = { route: Route; shapes: { shape_id: string; direction_ids: number[]; coordinates: [number, number][] }[]; stops: Stop[]; vehicles: Vehicle[] }
